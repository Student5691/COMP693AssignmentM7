...
const getEmployee = async (req, res) => {
    try {
        let {id:employeeId} = req.params //had to set an alias for "id" since its in routes.js as id, but id is too generic and casuing problerms, probably a reserved word for one of the modules
